  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <FontAwesomeIcon icon="ChevronDown" className="opacity-50" size={16} />
    ...
    >
      ...
      >
        <SelectPrimitive.ItemIndicator>
          <FontAwesomeIcon icon="Check" size={16} />
        </SelectPrimitive.ItemIndicator>
      </span>
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      {...props}
    >
      <FontAwesomeIcon icon="ChevronUp" size={16} />
    </SelectPrimitive.ScrollUpButton>
  )
}
...
function SelectScrollDownButton({
  ...
  return (
    <SelectPrimitive.ScrollDownButton
      ...
      {...props}
    >
      <FontAwesomeIcon icon="ChevronDown" size={16} />
    </SelectPrimitive.ScrollDownButton>
  )
}
